...
def create_staff(
    ...
    # Log audit
    log_audit(
        db, current_admin.id, "CREATE", "USER", 
        new_staff.id, {"email": new_staff.email}
    )
...
def reset_staff_password(
    ...
    log_audit(
        db, current_admin.id, "RESET_PASSWORD", "USER", 
        staff.id, {"email": staff.email}
    )
...
def toggle_staff_status(
    ...
    log_audit(
        db, current_admin.id, "TOGGLE", "USER", 
        staff.id, {"is_active": staff.is_active}
    )
